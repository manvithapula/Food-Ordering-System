...
//    }
    ...
    public void menu() {
        ...
        img1.setIcon(new ImageIcon(new ImageIcon("C:\\Users\\manvi\\IdeaProjects\\Food_ordering\\img\\1.jpg").getImage().getScaledInstance(img1.getWidth(), img1.getHeight(), Image.SCALE_DEFAULT)));
        // img1.setIcon(img_1);
        panel.add(img1);
        ...
        img2.setIcon(new ImageIcon(new ImageIcon("C:\\Users\\manvi\\IdeaProjects\\Food_ordering\\img\\2.jpeg").getImage().getScaledInstance(img1.getWidth(), img1.getHeight(), Image.SCALE_DEFAULT)));
        panel.add(img2);

        JLabel img3 = new JLabel("New label");
        img3.setBounds(310, 23, 82, 69);
        img3.setIcon(new ImageIcon(new ImageIcon("C:\\Users\\manvi\\IdeaProjects\\Food_ordering\\img\\3.jpeg").getImage().getScaledInstance(img1.getWidth(), img1.getHeight(), Image.SCALE_DEFAULT)));
        panel.add(img3);

        JLabel img4 = new JLabel("New label");
        img4.setBounds(440, 23, 82, 69);
        img4.setIcon(new ImageIcon(new ImageIcon("C:\\Users\\manvi\\IdeaProjects\\Food_ordering\\img\\4.jpeg").getImage().getScaledInstance(img1.getWidth(), img1.getHeight(), Image.SCALE_DEFAULT)));
        panel.add(img4);

        JLabel img5 = new JLabel("New label");
        img5.setBounds(569, 23, 82, 69);
        img5.setIcon(new ImageIcon(new ImageIcon("C:\\Users\\manvi\\IdeaProjects\\Food_ordering\\img\\5.jpeg").getImage().getScaledInstance(img1.getWidth(), img1.getHeight(), Image.SCALE_DEFAULT)));
        panel.add(img5);

        JLabel img6 = new JLabel("New label");
        img6.setBounds(20, 154, 82, 69);
        img6.setIcon(new ImageIcon(new ImageIcon("C:\\Users\\manvi\\IdeaProjects\\Food_ordering\\img\\6.jpeg").getImage().getScaledInstance(img1.getWidth(), img1.getHeight(), Image.SCALE_DEFAULT)));
        panel.add(img6);

        JLabel img7 = new JLabel("New label");
        img7.setBounds(171, 154, 82, 69);
        img7.setIcon(new ImageIcon(new ImageIcon("C:\\Users\\manvi\\IdeaProjects\\Food_ordering\\img\\7.jpg").getImage().getScaledInstance(img1.getWidth(), img1.getHeight(), Image.SCALE_DEFAULT)));
        panel.add(img7);

        JLabel img8 = new JLabel("New label");
        img8.setBounds(310, 154, 82, 69);
        img8.setIcon(new ImageIcon(new ImageIcon("C:\\Users\\manvi\\IdeaProjects\\Food_ordering\\img\\8.jpg").getImage().getScaledInstance(img1.getWidth(), img1.getHeight(), Image.SCALE_DEFAULT)));
        panel.add(img8);

        JLabel img9 = new JLabel("New label");
        img9.setBounds(440, 154, 82, 69);
        img9.setIcon(new ImageIcon(new ImageIcon("C:\\Users\\manvi\\IdeaProjects\\Food_ordering\\img\\9.jpg").getImage().getScaledInstance(img1.getWidth(), img1.getHeight(), Image.SCALE_DEFAULT)));
        panel.add(img9);

        JLabel img10 = new JLabel("New label");
        img10.setBounds(569, 154, 82, 69);
        img10.setIcon(new ImageIcon(new ImageIcon("C:\\Users\\manvi\\IdeaProjects\\Food_ordering\\img\\10.jpg").getImage().getScaledInstance(img1.getWidth(), img1.getHeight(), Image.SCALE_DEFAULT)));
        panel.add(img10);

        JLabel img11 = new JLabel("New label");
        img11.setBounds(32, 314, 82, 69);
        img11.setIcon(new ImageIcon(new ImageIcon("C:\\Users\\manvi\\IdeaProjects\\Food_ordering\\img\\11.jpg").getImage().getScaledInstance(img1.getWidth(), img1.getHeight(), Image.SCALE_DEFAULT)));
        panel.add(img11);

        JLabel img12 = new JLabel("New label");
        img12.setBounds(181, 314, 82, 69);
        img12.setIcon(new ImageIcon(new ImageIcon("C:\\Users\\manvi\\IdeaProjects\\Food_ordering\\img\\12.jpeg").getImage().getScaledInstance(img1.getWidth(), img1.getHeight(), Image.SCALE_DEFAULT)));
        panel.add(img12);

        JLabel img13 = new JLabel("New label");
        img13.setBounds(310, 314, 82, 69);
        img13.setIcon(new ImageIcon(new ImageIcon("C:\\Users\\manvi\\IdeaProjects\\Food_ordering\\img\\13.jpg").getImage().getScaledInstance(img1.getWidth(), img1.getHeight(), Image.SCALE_DEFAULT)));
        panel.add(img13);
